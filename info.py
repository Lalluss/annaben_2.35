...
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/b0547878f0968383d3880.jpg")
...
UPDATES_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('UPDATES_CHANNEL', '-1001646572603').split()]
...
BIN_CHANNEL =  [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('BIN_CHANNEL', '-1001965839568').split()]
